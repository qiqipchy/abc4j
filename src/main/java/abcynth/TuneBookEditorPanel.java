        ...
        new ListSelectionListener()
        {
          public void valueChanged(ListSelectionEvent e)
          {
            ...
            try
            {
              ...
              {
                int selectedTuneIndex = (Integer) m_tuneBookTable.getValueAt(selectedIndex, viewColumnNumber);
      ...
      try
      {
        while (true)
        {
          synchronized (m_mutex)
          {
            ...
            int selectedTuneReferenceNumber = (Integer) m_tuneBookTable.getValueAt(selectedIndex, viewColumnNumber);
